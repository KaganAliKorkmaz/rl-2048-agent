...
if __name__ == "__main__":
    if torch.cuda.is_available():
        ...
        device = "cpu"
    print("=" * 80)
    print("DENEY-1: REINFORCE (Entropy KAPALI)")
    print("=" * 80)
    ...
    plot_average_score(scores, window=100, smoothing_factor=0.9, save_path="experiment_1_training.png")
    print("\nRunning evaluation...")
    eval_scores, eval_best_tile = evaluate_policy(policy_net, num_episodes=50, device=device)
    print("\nGenerating evaluation plot...")
    plot_evaluation_scores(eval_scores, window=10, smoothing_factor=0.9, save_path="experiment_1_evaluation.png")
    print("\n" + "=" * 80)
    print("DENEY-1 SONUÇLARI:")
    print("=" * 80)
    ...
    print("=" * 80)
    print("Training and evaluation complete for Experiment 1.")
    print("=" * 80)
